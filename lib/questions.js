...
export const QUESTIONS = [
  ...
  {
    topic: 'Zákazník',
    q: 'Prodáváte sedačky do letadel. Kdo je vaším zákazníkem?',
  ...
  {
    topic: 'Zákazník',
    q: 'Kdo je vhodným early adopterem?',
    choices: [
      'Lidé, kteří jsou za můj produkt/službu ochotní zaplatit, i když to ještě není vyladěné',
      'Lidé, kterým můj produkt/služba sice nedává smysl, ale i tak si ji koupí',
      'Lidé, kteří silně vnímají problém, který řeším, a zároveň k nim mám blízko',
    ],
    correct: 0,
    confidence: 'medium',
  },
  ...
  {
    topic: 'Neférová výhoda',
    q: 'Je důležité mít neférovou výhodu?',
    choices: [
      'Ne, většina firem ji nemá a je většinou velice obtížné a drahé ji získat.',
      'Ano, díky neférové výhodě bude mít potenciální konkurence značně ztížený vstup na trh.',
      'Ano, jedině neférová výhoda vám vždy zajistí, že nebudete mít žádnou konkurenci.',
    ],
    correct: 1,
    confidence: 'medium',
  },
...
export function publicQuestion(index, revealed) {
  ...
  if (!item) return null;
  const { topic, q, choices, correct } = item;
  return {
    index,
